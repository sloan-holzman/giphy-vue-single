<template>
  <v-toolbar dark color="primary">
    <form v-on:submit.prevent="$emit('fetchSearchResults', searchText)">
      <v-text-field prepend-icon="search" hide-details single-line placeholder="search for GIFs" v-model="searchText"/>
    </form>
    <v-spacer></v-spacer>
